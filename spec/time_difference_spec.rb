  ...
  describe "#in_each_component" do
    with_each_class do |clazz|
      it "returns time difference in each component" do
        ...
        expect(TimeDifference.between(start_time, end_time).in_each_component).to eql({years: 0.91, months: 11.00, weeks: 47.71, days: 334.0, hours: 8016.0, minutes: 480960.0, seconds: 28857600.0})
      end
    end
  end
